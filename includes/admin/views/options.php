<div class="wrap">
	...
	<ol>
		...
		<li>Hit this <button class="aos-reindex-button button button-primary" data-nonce="<?php echo esc_attr( wp_create_nonce( 'wc_osa_reindex' ) ); ?>">Re-index orders</button> button</li>
	</ol>
